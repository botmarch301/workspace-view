...
![장문 프롬프트 결과](images/01_long_prompt_bad.png)
...
![핵심 프롬프트 결과](images/02_short_prompt_good.png)
...
![과도한 가중치 결과](images/03_weight_extreme.png)
...
![적절한 가중치 결과](images/04_weight_moderate.png)
...
![고해상도 직접 생성 결과](images/05_highres_bad.png)
...
![CFG 15 결과](images/06_cfg_high.png)
...
![CFG 3 결과](images/07_cfg_low.png)
...
![네거티브 없는 결과](images/10_no_negative.png)
...
![괜찮은 결과](images/08_default_ok.png)
...
![시리즈 작업물 첫 시도](images/11_series_first_try.png)
