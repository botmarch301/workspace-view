...
| 커스텀 도메인 | 불가 | 가능 | 가능 | 가능 | 가능 | 가능 |
| 버전 관리 | 없음 | 없음 | 플러그인 필요 | 없음 | Git 기반 | Git 기반 |
| 서버 관리 | 불필요 | 불필요 | 필요 | 불필요 | 불필요 | 불필요 |
| 이전 용이성 | 매우 낮음 | 낮음 | 중간 | 낮음 | 높음 | 높음 |
| 초기 설정 | 매우 쉬움 | 쉬움 | 보통 | 쉬움 | 보통 | 어려움 |
| 국내 검색 노출 | 매우 강함 | 강함 | 보통 | 약함 | 보통 | 보통 |
