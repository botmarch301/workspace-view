...
0.3에서도 얼굴이 미묘하게 달라지고, 1.0에서는 완전히 다른 사람이 된다. 소매 색까지 바뀌는 건 마스크가 얼굴 주변을 넉넉하게 덮었기 때문에, 높은 denoise에서 주변 영역까지 재생성된 결과다.
...
> **설정**: Realistic Vision V5.1 | guide_size 384 | DPM++ SDE Karras | Steps 20 | CFG 7.0 | Seed 42 | face_yolov8m
