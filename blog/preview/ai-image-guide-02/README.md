...
1화에서 txt2img만으로는 학다리 자세가 나오지 않았다. ControlNet을 배웠으니, 이번에는 참조 사진의 포즈를 지정해서 다시 시도한다.

태권도 학다리 자세 참조 사진을 OpenPose에 넣고, 목표 이미지를 생성했다.
...
| 1화 결과 (txt2img) | 2화 결과 (OpenPose ControlNet) |
|:---:|:---:|
| ![ep1](images/series_ep1_txt2img.png) | ![ep2](images/series_ep2_openpose.png) |

1화에서 포즈가 완전히 무시되던 것과 비교하면, 확실히 참조 포즈에 가까운 결과가 나온다. 하지만 여전히 완벽하지는 않다. 얼굴이 어색하고, 태권도복의 디테일도 부족하다.

포즈는 잡혔으니, 다음 단계는 얼굴과 디테일을 잡는 것이다.
