...
| 참조 사진 | 추출된 포즈맵 |
|:---:|:---:|
| ![reference](images/reference.jpg) | ![posemap](images/map_openpose.png) |
...
|:---:|:---:|:---:|
| ![e03](images/cmp_endpct_03.png) | ![e08](images/cmp_endpct_08.png) | ![e10](images/cmp_endpct_10.png) |
...
|:---:|:---:|:---:|:---:|
| ![ref](images/reference.jpg) | ![openpose](images/result_openpose.png) | ![canny](images/result_canny.png) | ![depth](images/result_depth.png) |

| | OpenPose 맵 | Canny 맵 | Depth 맵 |
|:---:|:---:|:---:|:---:|
| 전처리 결과 | ![map_op](images/map_openpose.png) | ![map_ca](images/map_canny.png) | ![map_de](images/map_depth.png) |
...
| OpenPose 포즈맵 | 생성 결과 |
|:---:|:---:|
| ![crane_map](images/series_crane_posemap.png) | ![ep2](images/series_ep2_openpose.png) |

1화 결과와 비교:

| 1화 결과 (txt2img, 포즈 제어 없음) | 2화 결과 (OpenPose ControlNet) |
|:---:|:---:|
| ![ep1](images/series_ep1_txt2img.png) | ![ep2](images/series_ep2_openpose.png) |
...
|:---:|:---:|:---:|
| ![openpose](images/series_ep2_openpose.png) | ![canny](images/series_ep2_canny.png) | ![depth](images/series_ep2_depth.png) |

OpenPose는 관절 위치만 참조하므로 배경, 의상, 인물 외형은 프롬프트대로 자유롭게 생성된다. Canny는 참조 사진의 윤곽선을 그대로 따라가서, 배경에 있던 관중이나 도장 환경까지 결과에 반영된다. Depth는 참조 사진의 공간 배치를 유지하면서도 세부 디테일은 어느 정도 자유롭다.

**포즈 제어가 목적이라면 OpenPose가 적합하다.** 관절 위치만 추출하기 때문에, 참조 사진에 있던 배경이나 의상에 끌려가지 않고 원하는 캐릭터를 만들 수 있다. 이 시리즈에서는 OpenPose 결과를 기준으로 진행한다.
...
**이미지 출처**
- 참조 사진 (포즈 추출용): [Pixabay](https://pixabay.com/photos/little-black-dress-fashion-model-6216037/) (Pixabay License, 상업적 이용 가능)
- 학다리 서기 참조: [TKD NEWS](http://www.tkdnews.com/news/articleView.html?idxno=53985) (포즈맵 추출 용도, 원본 사진 미게시)
