...
**스펙 주도 개발 도구** — 이미 대규모 커뮤니티를 형성한 도구들이다. 스펙 관리, 태스크 분해, 제약 주입 등 하네스의 앞단을 다룬다.
...
**하네스 전용 도구** — 2026년 초에 등장하기 시작한 신흥 도구들이다. 검증, 측정, 기계적 강제 등 하네스의 뒷단에 특화되어 있다. 아직 초기 단계지만 독특한 접근을 가지고 있어 주시할 가치가 있다.
